...
import Logar from "../../functions/Admin/LoginAdmin/Logar";
      ...
      >
        ...
        <div className="relative z-10 w-full max-w-sm">
          <Card className="w-full max-w-sm shadow-lg shadow-[#528a14]">
            ...
            <CardContent>
              <form onSubmit={(e) => Logar({e, email, senha, messageError, setMessageError, setControlError, controlError, navigate})}>
